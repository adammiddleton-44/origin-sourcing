...
const Index = () => {
  const seo = usePageSEO("/", {
    ...
    fallbackDescription: "Transform your packaging supply chain with expert procurement strategy. Achieve 20-35% cost savings with Origin Sourcing's specialist consulting services."
  });
  return <Layout>
