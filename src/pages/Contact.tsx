...
const Contact = () => {
  ...
  return <Layout>
      <SEO title={seo.title} description={seo.description} canonical="/contact" ogImage={seo.ogImage} noindex={seo.noindex} />
      {/* Hero */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1 animate-fade-up">
              ...
              <div className="space-y-6 mb-8">
                {contactInfo.map(item => <div key={item.label} className="flex items-start gap-4 group">
            ...
            {/* Form */}
            <div className="lg:col-span-2 animate-fade-up" style={{
            animationDelay: "0.1s"
          }}>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="email" name="email" type="email" value={formData.email} onChange={handleChange} placeholder="john@company.co.uk" className={errors.email ? "border-destructive" : ""} />
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="company" name="company" value={formData.company} onChange={handleChange} placeholder="Your Company Ltd" className={errors.company ? "border-destructive" : ""} />
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea id="message" name="message" value={formData.message} onChange={handleChange} placeholder="Tell us about your packaging challenges and what you're looking to achieve..." rows={5} className={errors.message ? "border-destructive" : ""} />
