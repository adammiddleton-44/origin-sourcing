...
export function HeroSection() {
  return <section className="relative overflow-hidden bg-gradient-to-br from-section-primary via-background to-section-accent">
      ...
      <div className="container-narrow relative py-[30px]">
        ...
        }}>Origin Sourcing helps multi-site restaurant and venue operators transition to direct purchasing, reducing packaging costs by 20-50%, whilst leveraging 3PL partnerships for seamless fulfilment.</p>
