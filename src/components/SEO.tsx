...
const DEFAULT_DESCRIPTION = "Transform your packaging supply chain with expert procurement strategy. Achieve 20-50% cost savings with Origin Sourcing's specialist consulting services.";
